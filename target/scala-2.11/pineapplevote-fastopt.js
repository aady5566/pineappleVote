...
/** @constructor */
function $c_Lweb_pineapple_PineappleApp$() {
  $c_O.call(this)
}
$c_Lweb_pineapple_PineappleApp$.prototype = new $h_O();
$c_Lweb_pineapple_PineappleApp$.prototype.constructor = $c_Lweb_pineapple_PineappleApp$;
/** @constructor */
function $h_Lweb_pineapple_PineappleApp$() {
  /*<skip>*/
}
$h_Lweb_pineapple_PineappleApp$.prototype = $c_Lweb_pineapple_PineappleApp$.prototype;
$c_Lweb_pineapple_PineappleApp$.prototype.init___ = (function() {
  return this
});
$c_Lweb_pineapple_PineappleApp$.prototype.main__V = (function() {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)((function() {
    $m_Lweb_pineapple_PineappleApp$().setupUI__V()
  }))
});
$c_Lweb_pineapple_PineappleApp$.prototype.setupUI__V = (function() {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("#click-me-button2").click((function() {
    $m_Lweb_pineapple_PineappleApp$().addClickedMessage__V()
  }))
});
$c_Lweb_pineapple_PineappleApp$.prototype.addClickedMessage__V = (function() {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("body").append("<p>You clicked the button!</p>")
});
$c_Lweb_pineapple_PineappleApp$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lweb_pineapple_PineappleApp$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lweb_pineapple_PineappleApp$ = new $TypeData().initClass({
  Lweb_pineapple_PineappleApp$: 0
}, false, "web.pineapple.PineappleApp$", {
  Lweb_pineapple_PineappleApp$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lweb_pineapple_PineappleApp$.prototype.$classData = $d_Lweb_pineapple_PineappleApp$;
var $n_Lweb_pineapple_PineappleApp$ = (void 0);
function $m_Lweb_pineapple_PineappleApp$() {
  if ((!$n_Lweb_pineapple_PineappleApp$)) {
    $n_Lweb_pineapple_PineappleApp$ = new $c_Lweb_pineapple_PineappleApp$().init___()
  };
  return $n_Lweb_pineapple_PineappleApp$
}
$e.web = ($e.web || {});
$e.web.pineapple = ($e.web.pineapple || {});
$e.web.pineapple.PineappleApp = $m_Lweb_pineapple_PineappleApp$;
/** @constructor */
...
//# sourceMappingURL=pineapplevote-fastopt.js.map
